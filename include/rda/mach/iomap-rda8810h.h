#ifndef __ASM_ARCH_RDA_IOMAP_RDA8810H_H
#define __ASM_ARCH_RDA_IOMAP_RDA8810H_H
...
#define RDA_GPU_MALI_BASE     (RDA_CAMERA_DMA_BASE + RDA_CAMERA_DMA_SIZE)
#define RDA_GPU_MALI_PHYS     0x20860000
#define RDA_GPU_MALI_SIZE     SZ_64K

#define RDA_PD_CTRL_BASE  (RDA_GPU_MALI_BASE + RDA_GPU_MALI_SIZE)
#define RDA_PD_CTRL_PHYS  0x20870000
#define RDA_PD_CTRL_SIZE  SZ_64K

#define RDA_VPU_JPEG_BASE     (RDA_PD_CTRL_BASE + RDA_PD_CTRL_SIZE)
#define RDA_VPU_JPEG_PHYS     0x20880000
#define RDA_VPU_JPEG_SIZE     SZ_64K

/* System counter used by A7 */
#define RDA_SYS_CNT_BASE     (RDA_VPU_JPEG_BASE + RDA_VPU_JPEG_SIZE)
#define RDA_SYS_CNT_PHYS     0x20890000
#define RDA_SYS_CNT_SIZE     SZ_64K
/* APB1 */
#define RDA_SYSCTRL_BASE      (RDA_SYS_CNT_BASE + RDA_SYS_CNT_SIZE)
...
/* Core timer */
#define RDA_TIMER2_BASE       (RDA_TIMER1_BASE + RDA_TIMER1_SIZE)
#define RDA_TIMER2_PHYS        0x20912000
#define RDA_TIMER2_SIZE        SZ_4K

/* Reserved mapping */
#define RDA_RES0_BASE       (RDA_TIMER2_BASE + RDA_TIMER2_SIZE)
...
#define RDA_DBGAPB_BASE       (RDA_DDRPHY_BASE + RDA_DDRPHY_SIZE)
#define RDA_DBGAPB_PHYS       0x209B0000
#define RDA_DBGAPB_SIZE       SZ_64K

#define RDA_AIF2_BASE         (RDA_DBGAPB_BASE + RDA_DBGAPB_SIZE)
...
#define RDA_UART3_SIZE        SZ_64K

#define RDA_GIC_BASE          (RDA_UART3_BASE + RDA_UART3_SIZE)
#define RDA_GIC_PHYS          0x20AA0000
...
#define RDA_IFC_BASE          (RDA_I2C3_BASE + RDA_I2C3_SIZE)
#define RDA_IFC_PHYS          0x20AF0000
#define RDA_IFC_SIZE          SZ_64K

#endif /* __ASM_ARCH_RDA_IOMAP_RDA8810H_H */
