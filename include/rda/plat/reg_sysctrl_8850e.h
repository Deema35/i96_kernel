...
/// AP GCG side System clocks
    ...
    GCG_CAMERA2                                 = 0x00000003,
/// the following don't have an auto enable
    GCG_ALWAYS                                  = 0x00000004,
    GCG_CONNECT                                 = 0x00000005,
    GCG_GOUDA_AW                                = 0x00000006,
    GCG_GOUDA_DPI                               = 0x00000007,
    GCG_ISP                                     = 0x00000008
} GCG_CLKS_T;

#define NB_GCG_CLK_AEN                          (4)
#define NB_GCG_CLK_EN                           (9)
#define NB_GCG_CLK                              (9)
...
/// the following don't have an auto enable
    ...
    AHB1_EMAC                                   = 0x00000003,
    AHB1_USBC2                                  = 0x00000004
} AHB1_CLKS_T;

#define NB_AHB1_CLK_AEN                         (1)
#define NB_AHB1_CLK_EN                          (5)
#define NB_AHB1_CLK                             (5)
...
/// AP APB1 side divided clock (either divided by module or by clock_ctrl)
    ...
    APB1D_OSC2                                  = 0x00000009,
    APB1D_OSC3                                  = 0x0000000A,
    APB1D_PWM                                   = 0x0000000B,
/// the following don't have an auto enable
    APB1_ALWAYS                                 = 0x0000000C,
    APB1_DAPLITE                                = 0x0000000D,
    APB1_TIMER                                  = 0x0000000E,
    APB1_GPIO                                   = 0x0000000F
} APB1_CLKS_T;

#define NB_APB1_CLK_AEN                         (12)
#define NB_APB1_CLK_EN                          (16)
#define NB_APB1_CLK                             (16)
...
/// AP APB2 side System clocks
    ...
    APB2_IFC_CH8                                = 0x0000000A,
    APB2_IFC_CH9                                = 0x0000000B,
    APB2_IFC_CH10                               = 0x0000000C,
    APB2_UART1                                  = 0x0000000D,
    APB2_UART2                                  = 0x0000000E,
    APB2_UART3                                  = 0x0000000F,
    APB2_UART4                                  = 0x00000010,
    APB2_SPI1                                   = 0x00000011,
    APB2_SPI2                                   = 0x00000012,
    APB2_SPI3                                   = 0x00000013,
    APB2_SDMMC1                                 = 0x00000014,
    APB2_SDMMC2                                 = 0x00000015,
    APB2_SDMMC3                                 = 0x00000016,
    APB2_I2C1                                   = 0x00000017,
    APB2_I2C2                                   = 0x00000018,
    APB2_I2C3                                   = 0x00000019,
/// the following don't have an auto enable
    APB2_ALWAYS                                 = 0x0000001A,
    APB2_NANDFLASH                              = 0x0000001B
} APB2_CLKS_T;

#define NB_APB2_CLK_AEN                         (26)
#define NB_APB2_CLK_EN                          (28)
#define NB_APB2_CLK                             (28)
...
/// clocks with auto enble
    ...
    APOC_UART4                                  = 0x00000006,
    APOC_VOC_CORE                               = 0x00000007,
    APOC_VOC2_CORE                              = 0x00000008,
    APOC_VOC                                    = 0x00000009,
    APOC_VOC2                                   = 0x0000000A,
/// the following don't have an auto enable
    APOC_VOC_ALWAYS                             = 0x0000000B,
    APOC_VOC2_ALWAYS                            = 0x0000000C,
    APOC_DDRPHY_N                               = 0x0000000D,
    APOC_DDRPHY2XP                              = 0x0000000E,
    APOC_DDRPHY2XN                              = 0x0000000F,
    APOC_GPU                                    = 0x00000010,
    APOC_USBPHY                                 = 0x00000011,
    APOC_CSI                                    = 0x00000012,
    APOC_CSI2                                   = 0x00000013,
    APOC_DSI                                    = 0x00000014,
    APOC_GPIO                                   = 0x00000015,
    APOC_SPIFLASH                               = 0x00000016,
    APOC_PIX                                    = 0x00000017,
    APOC_PIX2                                   = 0x00000018,
    APOC_PDGB                                   = 0x00000019
} APO_CLKS_T;

#define NB_CLK_VOC_AEN_SYNC                     (7)
#define NB_CLK_VOC_CORE                         (9)
#define NB_APO_CLK_AEN                          (11)
#define NB_CLK_VOC_END                          (13)
#define NB_APO_CLK_EN                           (26)
#define NB_APO_CLK                              (26)
...
/// AP CPU side resets
    ...
    CPU_RST_CORE1                               = 0x00000001,
    CPU_RST_CORE2                               = 0x00000002,
    CPU_RST_CORE3                               = 0x00000003,
    CPU_RST_L2                                  = 0x00000004,
    CPU_RST_SYS                                 = 0x00000005,
    CPU_RST_SOCA                                = 0x00000006
} CPU_RESETS_T;
...
/// AP AXI side resets: AXI and AHB0 and APB0
    ...
    APB0_RST_GPU                                = 0x00000005,
    APB0_RST_VPU                                = 0x00000006,
    APB0_RST_IRQ                                = 0x00000007,
    APB0_RST_AES                                = 0x00000008
} AXI_RESETS_T;
...
/// AP GCG side resets
    ...
    GCG_RST_CAMERA2                             = 0x00000003,
    GCG_RST_DPI                                 = 0x00000004
} GCG_RESETS_T;
...
/// AP AHB1 side resets
    ...
    AHB1_RST_EMAC                               = 0x00000003,
    AHB1_RST_USBC2                              = 0x00000004
} AHB1_RESETS_T;

#define NB_AHB1_RST                             (5)
...
/// AP APB1 side resets
    ...
    APB1_RST_COM_REGS                           = 0x00000008,
    APB1_RST_DMC                                = 0x00000009,
    APB1_RST_DDRPHY_P                           = 0x0000000A,
    APB1_RST_BB2G_XCPU                          = 0x0000000B,
    APB1_RST_BB2G_BCPU                          = 0x0000000C,
    APB1_RST_BB2G_AHBC                          = 0x0000000D,
    APB1_RST_BB2G_DMA                           = 0x0000000E,
    APB1_RST_BB2G_A2A                           = 0x0000000F,
    APB1_RST_BB2G_XIFC                          = 0x00000010,
    APB1_RST_BB2G_BIFC                          = 0x00000011,
    APB1_RST_BB2G_BAHBC                         = 0x00000012,
    APB1_RST_BB2G_MEM_BRIDGE                    = 0x00000013,
    APB1_RST_CVBS                               = 0x00000014,
    APB1_RST_TVCLK_CTRL                         = 0x00000015
} APB1_RESETS_T;
...
/// AP APB2 side resets
    ...
    APB2_RST_UART4                              = 0x00000005,
    APB2_RST_SPI1                               = 0x00000006,
    APB2_RST_SPI2                               = 0x00000007,
    APB2_RST_SPI3                               = 0x00000008,
    APB2_RST_SDMMC1                             = 0x00000009,
    APB2_RST_SDMMC2                             = 0x0000000A,
    APB2_RST_SDMMC3                             = 0x0000000B,
    APB2_RST_NANDFLASH                          = 0x0000000C,
    APB2_RST_I2C1                               = 0x0000000D,
    APB2_RST_I2C2                               = 0x0000000E,
    APB2_RST_I2C3                               = 0x0000000F
} APB2_RESETS_T;

#define NB_APB2_RST                             (16)
...
/// AP Reset Other : resync on corresponding clock other
    ...
    AP_RSTO_UART4                               = 0x0000000C,
    AP_RSTO_GPIO                                = 0x0000000D,
    AP_RSTO_TIMER                               = 0x0000000E,
    AP_RSTO_USBC                                = 0x0000000F,
    AP_RSTO_DSI                                 = 0x00000010,
    AP_RSTO_SPIFLASH                            = 0x00000011,
    AP_RSTO_TCK                                 = 0x00000012,
    AP_RSTO_PDBG_XTAL                           = 0x00000013,
    AP_RSTO_USBC2                               = 0x00000014
} AP_OTHERS_RESETS_T;

#define NB_AP_RSTO                              (21)
...
///
// =============================================================================
#define REG_AP_SYS_CTRL_BASE       0x00900000
...
typedef volatile struct
{
    ...
    REG32 Reserved_00000120[49];                //0x00000120
    ...
    /// This register is reserved.
    REG32                          Cfg_Reserve6;                 //0x00000200
    /// This register is reserved.
    REG32                          Cfg_hdmi;                     //0x00000204
} HWP_SYS_CTRL_AP_T;
...
#define SYS_CTRL_AP_SET_CPU_RST_SOCA (1<<6)
#define SYS_CTRL_AP_SOFT_RST       (1<<31)
#define SYS_CTRL_AP_SET_CPU_RST(n) (((n)&0x7F)<<0)
#define SYS_CTRL_AP_SET_CPU_RST_MASK (0x7F<<0)
...
#define SYS_CTRL_AP_CLR_CPU_RST_SOCA (1<<6)
#define SYS_CTRL_AP_CLR_CPU_RST(n) (((n)&0x7F)<<0)
#define SYS_CTRL_AP_CLR_CPU_RST_MASK (0x7F<<0)
...
#define SYS_CTRL_AP_SET_APB0_RST_AES (1<<8)
#define SYS_CTRL_AP_SET_AXI_RST(n) (((n)&0x1FF)<<0)
#define SYS_CTRL_AP_SET_AXI_RST_MASK (0x1FF<<0)
...
#define SYS_CTRL_AP_AXI_RST_CLR_VPU SYS_CTRL_AP_CLR_APB0_RST_VPU
#define SYS_CTRL_AP_CLR_APB0_RST_IRQ (1<<7)
#define SYS_CTRL_AP_CLR_APB0_RST_AES (1<<8)
#define SYS_CTRL_AP_CLR_AXI_RST(n) (((n)&0x1FF)<<0)
#define SYS_CTRL_AP_CLR_AXI_RST_MASK (0x1FF<<0)
...
#define SYS_CTRL_AP_AXIDIV2_RST_CLR_VPU SYS_CTRL_AP_CLR_AXIDIV2_RST_VPU
...
#define SYS_CTRL_AP_SET_GCG_RST_DPI (1<<4)
#define SYS_CTRL_AP_SET_GCG_RST(n) (((n)&31)<<0)
#define SYS_CTRL_AP_SET_GCG_RST_MASK (31<<0)
#define SYS_CTRL_AP_SET_GCG_RST_SHIFT (0)

//GCG_Rst_Clr
#define SYS_CTRL_AP_CLR_GCG_RST_SYS (1<<0)
#define SYS_CTRL_AP_CLR_GCG_RST_GOUDA (1<<1)
#define SYS_CTRL_AP_GCG_RST_CLR_GOUDA SYS_CTRL_AP_CLR_GCG_RST_GOUDA
#define SYS_CTRL_AP_CLR_GCG_RST_CAMERA (1<<2)
#define SYS_CTRL_AP_CLR_GCG_RST_CAMERA2 (1<<3)
#define SYS_CTRL_AP_CLR_GCG_RST_DPI (1<<4)
#define SYS_CTRL_AP_GCG_RST_CLR_LCDC SYS_CTRL_AP_CLR_GCG_RST_DPI
#define SYS_CTRL_AP_CLR_GCG_RST(n) (((n)&31)<<0)
#define SYS_CTRL_AP_CLR_GCG_RST_MASK (31<<0)
...
#define SYS_CTRL_AP_SET_AHB1_RST_USBC2 (1<<4)
#define SYS_CTRL_AP_SET_AHB1_RST(n) (((n)&31)<<0)
#define SYS_CTRL_AP_SET_AHB1_RST_MASK (31<<0)
...
#define SYS_CTRL_AP_CLR_AHB1_RST_USBC2 (1<<4)
#define SYS_CTRL_AP_CLR_AHB1_RST(n) (((n)&31)<<0)
#define SYS_CTRL_AP_CLR_AHB1_RST_MASK (31<<0)
...
#define SYS_CTRL_AP_SET_APB1_RST_CVBS (1<<20)
#define SYS_CTRL_AP_SET_APB1_RST_TVCLK_CTRL (1<<21)
...
#define SYS_CTRL_AP_CLR_APB1_RST_CVBS (1<<20)
#define SYS_CTRL_AP_CLR_APB1_RST_TVCLK_CTRL (1<<21)
...
#define SYS_CTRL_AP_SET_APB2_RST_UART4 (1<<5)
#define SYS_CTRL_AP_SET_APB2_RST_SPI1 (1<<6)
#define SYS_CTRL_AP_SET_APB2_RST_SPI2 (1<<7)
#define SYS_CTRL_AP_SET_APB2_RST_SPI3 (1<<8)
#define SYS_CTRL_AP_SET_APB2_RST_SDMMC1 (1<<9)
#define SYS_CTRL_AP_SET_APB2_RST_SDMMC2 (1<<10)
#define SYS_CTRL_AP_SET_APB2_RST_SDMMC3 (1<<11)
#define SYS_CTRL_AP_SET_APB2_RST_NANDFLASH (1<<12)
#define SYS_CTRL_AP_SET_APB2_RST_I2C1 (1<<13)
#define SYS_CTRL_AP_SET_APB2_RST_I2C2 (1<<14)
#define SYS_CTRL_AP_SET_APB2_RST_I2C3 (1<<15)
#define SYS_CTRL_AP_SET_APB2_RST(n) (((n)&0xFFFF)<<0)
#define SYS_CTRL_AP_SET_APB2_RST_MASK (0xFFFF<<0)
...
#define SYS_CTRL_AP_CLR_APB2_RST_UART4 (1<<5)
#define SYS_CTRL_AP_CLR_APB2_RST_SPI1 (1<<6)
#define SYS_CTRL_AP_CLR_APB2_RST_SPI2 (1<<7)
#define SYS_CTRL_AP_CLR_APB2_RST_SPI3 (1<<8)
#define SYS_CTRL_AP_CLR_APB2_RST_SDMMC1 (1<<9)
#define SYS_CTRL_AP_CLR_APB2_RST_SDMMC2 (1<<10)
#define SYS_CTRL_AP_CLR_APB2_RST_SDMMC3 (1<<11)
#define SYS_CTRL_AP_CLR_APB2_RST_NANDFLASH (1<<12)
#define SYS_CTRL_AP_CLR_APB2_RST_I2C1 (1<<13)
#define SYS_CTRL_AP_CLR_APB2_RST_I2C2 (1<<14)
#define SYS_CTRL_AP_CLR_APB2_RST_I2C3 (1<<15)
#define SYS_CTRL_AP_CLR_APB2_RST(n) (((n)&0xFFFF)<<0)
#define SYS_CTRL_AP_CLR_APB2_RST_MASK (0xFFFF<<0)
...
#define SYS_CTRL_AP_ENABLE_AXI_AES (1<<7)
...
#define SYS_CTRL_AP_DISABLE_AXI_AES (1<<7)
...
#define SYS_CTRL_AP_MODE_CLK_GCG(n) (((n)&15)<<0)
#define SYS_CTRL_AP_MODE_CLK_GCG_MASK (15<<0)
...
#define SYS_CTRL_AP_ENABLE_GCG_DPI SYS_CTRL_AP_ENABLE_GCG_GOUDA_DPI
#define SYS_CTRL_AP_ENABLE_GCG_ISP (1<<8)
#define SYS_CTRL_AP_ENABLE_CLK_GCG(n) (((n)&0x1FF)<<0)
#define SYS_CTRL_AP_ENABLE_CLK_GCG_MASK (0x1FF<<0)
...
#define SYS_CTRL_AP_DISABLE_GCG_DPI SYS_CTRL_AP_DISABLE_GCG_GOUDA_DPI
#define SYS_CTRL_AP_DISABLE_GCG_ISP (1<<8)
#define SYS_CTRL_AP_DISABLE_CLK_GCG(n) (((n)&0x1FF)<<0)
#define SYS_CTRL_AP_DISABLE_CLK_GCG_MASK (0x1FF<<0)
...
#define SYS_CTRL_AP_ENABLE_AHB1_USBC2 (1<<4)
#define SYS_CTRL_AP_ENABLE_CLK_AHB1(n) (((n)&31)<<0)
#define SYS_CTRL_AP_ENABLE_CLK_AHB1_MASK (31<<0)
...
#define SYS_CTRL_AP_DISABLE_AHB1_USBC2 (1<<4)
#define SYS_CTRL_AP_DISABLE_CLK_AHB1(n) (((n)&31)<<0)
#define SYS_CTRL_AP_DISABLE_CLK_AHB1_MASK (31<<0)
...
#define SYS_CTRL_AP_MODE_APB2_UART4_AUTOMATIC (0<<16)
#define SYS_CTRL_AP_MODE_APB2_UART4_MANUAL (1<<16)
#define SYS_CTRL_AP_MODE_APB2_SPI1_AUTOMATIC (0<<17)
#define SYS_CTRL_AP_MODE_APB2_SPI1_MANUAL (1<<17)
#define SYS_CTRL_AP_MODE_APB2_SPI2_AUTOMATIC (0<<18)
#define SYS_CTRL_AP_MODE_APB2_SPI2_MANUAL (1<<18)
#define SYS_CTRL_AP_MODE_APB2_SPI3_AUTOMATIC (0<<19)
#define SYS_CTRL_AP_MODE_APB2_SPI3_MANUAL (1<<19)
#define SYS_CTRL_AP_MODE_APB2_SDMMC1_AUTOMATIC (0<<20)
#define SYS_CTRL_AP_MODE_APB2_SDMMC1_MANUAL (1<<20)
#define SYS_CTRL_AP_MODE_APB2_SDMMC2_AUTOMATIC (0<<21)
#define SYS_CTRL_AP_MODE_APB2_SDMMC2_MANUAL (1<<21)
#define SYS_CTRL_AP_MODE_APB2_SDMMC3_AUTOMATIC (0<<22)
#define SYS_CTRL_AP_MODE_APB2_SDMMC3_MANUAL (1<<22)
#define SYS_CTRL_AP_MODE_APB2_I2C1_AUTOMATIC (0<<23)
#define SYS_CTRL_AP_MODE_APB2_I2C1_MANUAL (1<<23)
#define SYS_CTRL_AP_MODE_APB2_I2C2_AUTOMATIC (0<<24)
#define SYS_CTRL_AP_MODE_APB2_I2C2_MANUAL (1<<24)
#define SYS_CTRL_AP_MODE_APB2_I2C3_AUTOMATIC (0<<25)
#define SYS_CTRL_AP_MODE_APB2_I2C3_MANUAL (1<<25)
#define SYS_CTRL_AP_MODE_CLK_APB2(n) (((n)&0x3FFFFFF)<<0)
#define SYS_CTRL_AP_MODE_CLK_APB2_MASK (0x3FFFFFF<<0)
...
#define SYS_CTRL_AP_ENABLE_APB2_UART4 (1<<16)
#define SYS_CTRL_AP_ENABLE_APB2_SPI1 (1<<17)
#define SYS_CTRL_AP_ENABLE_APB2_SPI2 (1<<18)
#define SYS_CTRL_AP_ENABLE_APB2_SPI3 (1<<19)
#define SYS_CTRL_AP_ENABLE_APB2_SDMMC1 (1<<20)
#define SYS_CTRL_AP_ENABLE_APB2_SDMMC2 (1<<21)
#define SYS_CTRL_AP_ENABLE_APB2_SDMMC3 (1<<22)
#define SYS_CTRL_AP_ENABLE_APB2_I2C1 (1<<23)
#define SYS_CTRL_AP_ENABLE_APB2_I2C2 (1<<24)
#define SYS_CTRL_AP_ENABLE_APB2_I2C3 (1<<25)
#define SYS_CTRL_AP_ENABLE_APB2_ALWAYS (1<<26)
#define SYS_CTRL_AP_ENABLE_APB2_NANDFLASH (1<<27)
#define SYS_CTRL_AP_ENABLE_CLK_APB2(n) (((n)&0xFFFFFFF)<<0)
#define SYS_CTRL_AP_ENABLE_CLK_APB2_MASK (0xFFFFFFF<<0)
...
#define SYS_CTRL_AP_DISABLE_APB2_UART4 (1<<16)
#define SYS_CTRL_AP_DISABLE_APB2_SPI1 (1<<17)
#define SYS_CTRL_AP_DISABLE_APB2_SPI2 (1<<18)
#define SYS_CTRL_AP_DISABLE_APB2_SPI3 (1<<19)
#define SYS_CTRL_AP_DISABLE_APB2_SDMMC1 (1<<20)
#define SYS_CTRL_AP_DISABLE_APB2_SDMMC2 (1<<21)
#define SYS_CTRL_AP_DISABLE_APB2_SDMMC3 (1<<22)
#define SYS_CTRL_AP_DISABLE_APB2_I2C1 (1<<23)
#define SYS_CTRL_AP_DISABLE_APB2_I2C2 (1<<24)
#define SYS_CTRL_AP_DISABLE_APB2_I2C3 (1<<25)
#define SYS_CTRL_AP_DISABLE_APB2_ALWAYS (1<<26)
#define SYS_CTRL_AP_DISABLE_APB2_NANDFLASH (1<<27)
#define SYS_CTRL_AP_DISABLE_CLK_APB2(n) (((n)&0xFFFFFFF)<<0)
#define SYS_CTRL_AP_DISABLE_CLK_APB2_MASK (0xFFFFFFF<<0)
...
#define SYS_CTRL_AP_MODE_APOC_UART4_AUTOMATIC (0<<6)
#define SYS_CTRL_AP_MODE_APOC_UART4_MANUAL (1<<6)
#define SYS_CTRL_AP_MODE_APOC_VOC_CORE_AUTOMATIC (0<<7)
#define SYS_CTRL_AP_MODE_APOC_VOC_CORE_MANUAL (1<<7)
#define SYS_CTRL_AP_MODE_APOC_VOC2_CORE_AUTOMATIC (0<<8)
#define SYS_CTRL_AP_MODE_APOC_VOC2_CORE_MANUAL (1<<8)
#define SYS_CTRL_AP_MODE_APOC_VOC_AUTOMATIC (0<<9)
#define SYS_CTRL_AP_MODE_APOC_VOC_MANUAL (1<<9)
#define SYS_CTRL_AP_MODE_APOC_VOC2_AUTOMATIC (0<<10)
#define SYS_CTRL_AP_MODE_APOC_VOC2_MANUAL (1<<10)
#define SYS_CTRL_AP_MODE_CLK_APO(n) (((n)&0x7FF)<<0)
#define SYS_CTRL_AP_MODE_CLK_APO_MASK (0x7FF<<0)
...
#define SYS_CTRL_AP_ENABLE_APOC_UART4 (1<<6)
#define SYS_CTRL_AP_ENABLE_APOC_VOC_CORE (1<<7)
#define SYS_CTRL_AP_ENABLE_APOC_VOC2_CORE (1<<8)
#define SYS_CTRL_AP_ENABLE_APOC_VOC (1<<9)
#define SYS_CTRL_AP_ENABLE_APOC_VOC2 (1<<10)
#define SYS_CTRL_AP_ENABLE_APOC_VOC_ALWAYS (1<<11)
#define SYS_CTRL_AP_ENABLE_APOC_VOC2_ALWAYS (1<<12)
#define SYS_CTRL_AP_ENABLE_APOC_DDRPHY_N (1<<13)
#define SYS_CTRL_AP_ENABLE_APOC_DDRPHY2XP (1<<14)
#define SYS_CTRL_AP_ENABLE_APOC_DDRPHY2XN (1<<15)
#define SYS_CTRL_AP_ENABLE_APOC_GPU (1<<16)
#define SYS_CTRL_AP_ENABLE_APOC_USBPHY (1<<17)
#define SYS_CTRL_AP_ENABLE_APOC_CSI (1<<18)
#define SYS_CTRL_AP_ENABLE_APOC_CSI2 (1<<19)
#define SYS_CTRL_AP_ENABLE_APOC_DSI (1<<20)
#define SYS_CTRL_AP_ENABLE_APOC_GPIO (1<<21)
#define SYS_CTRL_AP_ENABLE_APOC_SPIFLASH (1<<22)
#define SYS_CTRL_AP_ENABLE_APOC_PIX (1<<23)
#define SYS_CTRL_AP_ENABLE_APOC_PIX2 (1<<24)
#define SYS_CTRL_AP_ENABLE_APOC_PDGB (1<<25)
#define SYS_CTRL_AP_ENABLE_CLK_APO(n) (((n)&0x3FFFFFF)<<0)
#define SYS_CTRL_AP_ENABLE_CLK_APO_MASK (0x3FFFFFF<<0)
...
#define SYS_CTRL_AP_DISABLE_APOC_UART4 (1<<6)
#define SYS_CTRL_AP_DISABLE_APOC_VOC_CORE (1<<7)
#define SYS_CTRL_AP_DISABLE_APOC_VOC2_CORE (1<<8)
#define SYS_CTRL_AP_DISABLE_APOC_VOC (1<<9)
#define SYS_CTRL_AP_DISABLE_APOC_VOC2 (1<<10)
#define SYS_CTRL_AP_DISABLE_APOC_VOC_ALWAYS (1<<11)
#define SYS_CTRL_AP_DISABLE_APOC_VOC2_ALWAYS (1<<12)
#define SYS_CTRL_AP_DISABLE_APOC_DDRPHY_N (1<<13)
#define SYS_CTRL_AP_DISABLE_APOC_DDRPHY2XP (1<<14)
#define SYS_CTRL_AP_DISABLE_APOC_DDRPHY2XN (1<<15)
#define SYS_CTRL_AP_DISABLE_APOC_GPU (1<<16)
#define SYS_CTRL_AP_DISABLE_APOC_USBPHY (1<<17)
#define SYS_CTRL_AP_DISABLE_APOC_CSI (1<<18)
#define SYS_CTRL_AP_DISABLE_APOC_CSI2 (1<<19)
#define SYS_CTRL_AP_DISABLE_APOC_DSI (1<<20)
#define SYS_CTRL_AP_DISABLE_APOC_GPIO (1<<21)
#define SYS_CTRL_AP_DISABLE_APOC_SPIFLASH (1<<22)
#define SYS_CTRL_AP_DISABLE_APOC_PIX (1<<23)
#define SYS_CTRL_AP_DISABLE_APOC_PIX2 (1<<24)
#define SYS_CTRL_AP_DISABLE_APOC_PDGB (1<<25)
#define SYS_CTRL_AP_DISABLE_CLK_APO(n) (((n)&0x3FFFFFF)<<0)
#define SYS_CTRL_AP_DISABLE_CLK_APO_MASK (0x3FFFFFF<<0)
...
#define SYS_CTRL_AP_DBG_CLK_DIV_SEL(n) (((n)&15)<<20)
#define SYS_CTRL_AP_DBG_CLK_DIV_SEL_MASK (15<<20)
#define SYS_CTRL_AP_DBG_CLK_DIV_SEL_SHIFT (20)
...
//Cfg_Reserve
//#define SYS_CTRL_AP_RESERVE(n)   (((n)&0x1FFFFFFF)<<0)
#define SYS_CTRL_AP_FIQ_IRQ_MASK   (1<<29)
