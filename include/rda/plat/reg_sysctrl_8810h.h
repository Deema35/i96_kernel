...
#define NB_AHB1_CLK_EN                          (4)
#define NB_AHB1_CLK                             (4)
...
/// AP APB2 side System clocks
    ...
    APB2_SPI1                                   = 0x00000010,
    APB2_SPI2                                   = 0x00000011,
    APB2_SPI3                                   = 0x00000012,
    APB2_SDMMC1                                 = 0x00000013,
    APB2_SDMMC2                                 = 0x00000014,
    APB2_SDMMC3                                 = 0x00000015,
    APB2_I2C1                                   = 0x00000016,
    APB2_I2C2                                   = 0x00000017,
    APB2_I2C3                                   = 0x00000018,
/// the following don't have an auto enable
    APB2_ALWAYS                                 = 0x00000019,
    APB2_NANDFLASH                              = 0x0000001A
} APB2_CLKS_T;

#define NB_APB2_CLK_AEN                         (25)
#define NB_APB2_CLK_EN                          (27)
#define NB_APB2_CLK                             (27)
...
/// the following don't have an auto enable
    MEM_DMC                                     = 0x00000001,
    MEM_DDRPHY_P                                = 0x00000002,
    MEM_CONNECT                                 = 0x00000003
} MEM_CLKS_T;

#define NB_MEM_CLK_AEN                           (1)
#define NB_MEM_CLK_EN                            (4)
#define NB_MEM_CLK                               (4)
...
/// clocks with auto enble
    APOC_BCK                                    = 0x00000000,
    APOC_BCK2                                   = 0x00000001,
    APOC_UART1                                  = 0x00000002,
    APOC_UART2                                  = 0x00000003,
    APOC_UART3                                  = 0x00000004,
    APOC_VOC_CORE                               = 0x00000005,
    APOC_VOC2_CORE                              = 0x00000006,
    APOC_VOC                                    = 0x00000007,
    APOC_VOC2                                   = 0x00000008,
/// the following don't have an auto enable
    APOC_VOC_ALWAYS                             = 0x00000009,
    APOC_VOC2_ALWAYS                            = 0x0000000A,
    APOC_DDRPHY_N                               = 0x0000000B,
    APOC_DDRPHY2XP                              = 0x0000000C,
    APOC_DDRPHY2XN                              = 0x0000000D,
    APOC_VPU                                    = 0x0000000E,
    APOC_GPU                                    = 0x0000000F,
    APOC_USBPHY                                 = 0x00000010,
    APOC_CSI                                    = 0x00000011,
    APOC_CSI2                                   = 0x00000012,
    APOC_DSI                                    = 0x00000013,
    APOC_GPIO                                   = 0x00000014,
    APOC_SPIFLASH                               = 0x00000015,
    APOC_PIX                                    = 0x00000016,
    APOC_PIX2                                   = 0x00000017,
    APOC_PDGB                                   = 0x00000018
} APO_CLKS_T;

#define NB_CLK_VOC_AEN_SYNC                     (5)
#define NB_CLK_VOC_CORE                         (7)
#define NB_APO_CLK_AEN                          (9)
#define NB_CLK_VOC_END                          (11)
#define NB_APO_CLK_EN                           (25)
#define NB_APO_CLK                              (25)
...
/// AP APB2 side resets
    ...
    APB2_RST_I2C1                               = 0x0000000C,
    APB2_RST_I2C2                               = 0x0000000D,
    APB2_RST_I2C3                               = 0x0000000E
} APB2_RESETS_T;

#define NB_APB2_RST                             (15)
...
/// AP MEM side resets
    ...
    MEM_RST_DMC                                 = 0x00000001,
    MEM_RST_DDRPHY_P                            = 0x00000002
} MEM_RESETS_T;
...
#define SYS_CTRL_AP_SET_CPU_RST_SOCA (1<<31)
#define SYS_CTRL_AP_SOFT_RST  SYS_CTRL_AP_SET_CPU_RST_SOCA
#define SYS_CTRL_AP_SET_CPU_RST(n) (((n)&0x1F)<<0)
#define SYS_CTRL_AP_SET_CPU_RST_MASK (0x1F<<0)
